...
# zscore_binsize = 1
# bins_zscores = np.arange(0, math.ceil(max(CLAGN_zscores)), zscore_binsize)
# # # #CLAGN
# # bins_zscores = np.arange(min(CLAGN_zscores), max(CLAGN_zscores) + 0.05, 0.05)
...
# bins_norm_flux_change = np.arange(0, 1, norm_flux_change_binsize)
# # # #CLAGN
